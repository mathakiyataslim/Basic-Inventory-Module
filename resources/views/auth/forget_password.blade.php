      ...
      <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
        <div class="card border border-light-subtle rounded-3 shadow-sm mt-5">
          <div class="card-body p-3 p-md-4 p-xl-5">
            ...
            <h2 class="fs-6 fw-normal text-center text-secondary mb-4">Forget Password</h2>
            <form method="POST" action="{{route('forget_pass_save')}}">
              @csrf
              ...
              <div class="row gy-2 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="d-grid my-3">
                    <button class="btn btn-primary btn-lg" type="submit">Forget Password</button>
                  </div>
                </div>
