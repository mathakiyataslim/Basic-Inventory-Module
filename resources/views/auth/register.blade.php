        ...
        <div class="card border border-light-subtle rounded-3 shadow-sm">
          <div class="card-body p-3 p-md-4 p-xl-5">
            <div class="text-center mb-3">
             <h4 class="fw-bold text-primary">Creat Your Account</h4>
            </div>
            ...
            <form method="POST" action="{{route('registersave')}}">
              ...
              <div class="row gy-2 overflow-hidden">
                ...
                <div class="col-12">
                  ...
                  <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" value="" placeholder="Phone" required>
